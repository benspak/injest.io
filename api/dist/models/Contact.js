...
export class ContactModel {
     ...
     */
    static isDeterministicallyEncrypted(value) {
     ...
     */
    static decryptContacts(contacts) {
        return contacts.map(contact => this.decryptContact(contact)).filter((c) => c !== null);
    }
    ...
    static async searchForSend(ownerId, options = {}) {
        ...
        const orderBy = orderSegments.length > 0
