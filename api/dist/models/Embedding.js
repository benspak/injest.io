...
export class EmbeddingModel {
    static async create(documentId, embedding) {
    ...
    static async deleteByDocumentId(documentId) {
        const result = await pool.query('DELETE FROM search_embeddings WHERE document_id = $1', [documentId]);
        ...
        return result.rows.map((row) => {
            ...
            return {
                ...
                document: {
                    ...
                    metadata: document_metadata && typeof document_metadata === 'object'
                        ? document_metadata
                        : {},
                },
                item: item_json && typeof item_json === 'object'
                    ? item_json
                    : undefined,
