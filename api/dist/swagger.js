...
const swaggerDefinition = {
    ...
    info: {
        title: 'Injest API',
        version: '1.0.0',
        description: 'Public developer documentation for the Injest API. Authenticate with a user session token or an API key to ingest, organize, and search captured knowledge.',
        contact: {
            name: 'Injest Support',
