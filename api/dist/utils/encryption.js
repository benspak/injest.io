 ...
 */
function getDeterministicIV(plaintext) {
 ...
 */
export function encrypt(plaintext, deterministic = false) {
    if (!plaintext) {
        return plaintext;
    }
    try {
 ...
 */
export function encryptField(value, deterministic = false) {
 ...
 */
export function encryptJSON(obj, deterministic = false) {
    if (!obj) {
        return '';
    }
 ...
 */
export function encryptSearchable(plaintext) {
    if (!plaintext) {
 ...
 */
export function decryptSearchable(encrypted) {
    if (!encrypted) {
        return encrypted;
    }
 ...
 */
export function createSearchableHash(value) {
    if (!value) {
        return '';
    }
    const key = getEncryptionKey();
 ...
 */
export function decryptJSON(encryptedJson) {
    if (!encryptedJson) {
        return null;
    }
    try {
