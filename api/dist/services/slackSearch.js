 ...
 */
function generatePermalink(workspaceId, channelId, messageTs) {
...
export class SlackSearchService {
    ...
    async searchMessages(userId, query, options = {}) {
        ...
        const searchResults = await searchService.search({ id: userId }, query, limit * 2, // Get more results to filter
        {
     ...
     */
    async searchChannel(userId, channelId, workspaceId, query, options = {}) {
     ...
     */
    async getMessageContext(userId, workspaceId, channelId, messageTs) {
        // Find the message
...
//# sourceMappingURL=slackSearch.js.map