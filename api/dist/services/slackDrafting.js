...
export class SlackDraftingService {
     ...
     */
    async draftReply(channelId, workspaceId, userId, threadTs, context, options = {}) {
...
Draft a concise and helpful reply. Keep it under 500 characters. Do not include markdown formatting.`;
     ...
     */
    async draftMessage(channelId, workspaceId, userId, context, options = {}) {
...
Draft a concise and helpful message. Keep it under 500 characters. Do not include markdown formatting.`;
     ...
     */
    async postMessage(channelId, workspaceId, userId, text, options = {}) {
     ...
     */
    async draftAndPostReply(channelId, workspaceId, userId, threadTs, context, options = {}) {
...
//# sourceMappingURL=slackDrafting.js.map