...
export class ReferralService {
   ...
   */
  static validateReferralCode(code: string): { valid: boolean; error?: string } {
   ...
   */
  static async isCodeAvailable(code: string, excludeUserId?: string): Promise<boolean> {
   ...
   */
  static async setReferralCode(userId: string, code: string): Promise<void> {
